...
const Wallets = () => {
    ...
    const tabs = useMemo(() => {
        return [
            ...
            {
                value: "peer-trade-fee",
                label: intl.formatMessage(messages.peerTradeFee),
                icon: percent,
                component: <PeerTradeFee />
            }
        ];
    }, [intl]);
